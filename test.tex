...
\begin{figure}[htbp]
    \centering
    \subfloat{\includegraphics[width=0.3\textwidth]{zeeman.png}}....
    \subfloat{\includegraphics[width=0.3\textwidth]{zeeman_spe.png}}
...
\begin{figure}[htbp]
    \centering
    \subfloat{\includegraphics[width=0.3\textwidth]{quad.png}}....
    \subfloat{\includegraphics[width=0.3\textwidth]{quad_spe.png}}
